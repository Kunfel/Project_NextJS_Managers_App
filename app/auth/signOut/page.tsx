...
const formSchema = z.object({
  ...
  name2: z.string().min(2, "String must contain at least 2 characters"),
  ...
  return (
    <div className="flex flex-col-2 h-screen bg-gray-100 overflow-hidden shadow-xl">
      ...
      <div className="flex items-center justify-center">
        <div className="flex flex-col justify-center bg-white w-[400px] h-[500px] mx-48 rounded-lg p-5">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <p className="text-sm text-gray-600 mt-0">
                ...
                <Link href="/auth/signIn" className="text-[#8053FF] hover:underline">
                  Login
                </Link>
              </p>
            </form>
